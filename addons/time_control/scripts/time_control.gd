...
func _enter_tree() -> void:
	...
	add_custom_type("TimeController", "Node", preload("res://addons/time_control/scripts/time_controller.gd"), preload("res://addons/time_control/time_control.svg"))
	add_custom_type("Timeline", "Node", preload("res://addons/time_control/scripts/timeline.gd"), preload("res://addons/time_control/time_control.svg"))
	add_custom_type("Clock", "Node", preload("res://addons/time_control/scripts/clock.gd"), preload("res://addons/time_control/time_control.svg"))
	add_custom_type("ClockConfiguration", "Resource", preload("res://addons/time_control/scripts/clock_configuration.gd"), preload("res://addons/time_control/time_control.svg"))
